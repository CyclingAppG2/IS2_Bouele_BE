...
#              new_admin_session GET      /auth_admin/sign_in(.:format)             devise_token_auth/sessions#new
#                  admin_session POST     /auth_admin/sign_in(.:format)             devise_token_auth/sessions#create
#          destroy_admin_session DELETE   /auth_admin/sign_out(.:format)            devise_token_auth/sessions#destroy
...
#         organization_new_event POST     /organization/new_event(.:format)         organizations#createEvent
...
#           voluntary_join_event POST     /voluntary/join_event(.:format)           voluntaries#joinEvent
...
#                                GET      /user_polymorphisms(.:format)             user_polymorphisms#index
#                                POST     /user_polymorphisms(.:format)             user_polymorphisms#create
#                                GET      /user_polymorphisms/:id(.:format)         user_polymorphisms#show
#                                PATCH    /user_polymorphisms/:id(.:format)         user_polymorphisms#update
#                                PUT      /user_polymorphisms/:id(.:format)         user_polymorphisms#update
#                                DELETE   /user_polymorphisms/:id(.:format)         user_polymorphisms#destroy
